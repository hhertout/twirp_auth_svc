...
func (c *authenticationServiceProtobufClient) Login(ctx context.Context, in *LoginRequest) (*LoginResponse, error) {
...
func (c *authenticationServiceProtobufClient) callLogin(ctx context.Context, in *LoginRequest) (*LoginResponse, error) {
...
func (c *authenticationServiceJSONClient) Login(ctx context.Context, in *LoginRequest) (*LoginResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "auth")
	ctx = ctxsetters.WithServiceName(ctx, "AuthenticationService")
	ctx = ctxsetters.WithMethodName(ctx, "Login")
	caller := c.callLogin
...
func (c *authenticationServiceJSONClient) callLogin(ctx context.Context, in *LoginRequest) (*LoginResponse, error) {
	out := new(LoginResponse)
...
const AuthenticationServicePathPrefix = "/twirp/auth.AuthenticationService/"
...
func (s *authenticationServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	if pkgService != "auth.AuthenticationService" {
...
func (s *authenticationServiceServer) serveRegister(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	header := req.Header.Get("Content-Type")
	i := strings.Index(header, ";")
	if i == -1 {
		i = len(header)
...
func (s *authenticationServiceServer) serveRegisterJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Register")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) serveRegisterProtobuf(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	var err error
	ctx = ctxsetters.WithMethodName(ctx, "Register")
	ctx, err = callRequestRouted(ctx, s.hooks)
	if err != nil {
...
func (s *authenticationServiceServer) PathPrefix() string {
	return baseServicePath(s.pathPrefix, "auth", "AuthenticationService")
}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
